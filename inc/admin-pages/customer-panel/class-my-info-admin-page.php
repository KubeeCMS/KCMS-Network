 ...
 * WP Ultimo My_Info Admin Page.
 */
class My_Info_Admin_Page extends Base_Admin_Page {
	...
	public function output() {
		...
		echo "<div class='wrap'><h1>My Info</h1></div>";

	} // end output;

} // end class My_Info_Admin_Page;
