 ...
 * WP Ultimo Dashboard Admin Page.
 */
class Support_Agent_List_Admin_Page extends List_Admin_Page {
	...
	function render_add_new_support_agent_modal() {
		...
		$fields = array(
			...
			'submit_button' => array(
				'type'            => 'submit',
				'title'           => __('Create Support Agent', 'wp-ultimo'),
				'value'           => 'save',
	...
	public function handle_add_new_support_agent_modal() {
		...
		/*
			...
			*/
		$customer = wu_create_support_agent($customer_data);
	...
	public function get_title() {
		...
		return __('Support Agents', 'wp-ultimo');
	...
	public function table() {
		...
		return new \WP_Ultimo\List_Tables\Support_Agent_List_Table();
