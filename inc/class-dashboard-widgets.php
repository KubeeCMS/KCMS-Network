...
class Dashboard_Widgets {
	...
	public function register_network_widgets() {
		...
		\WP_Ultimo\UI\Tours::get_instance()->create_tour('dashboard', array(
			...
			array(
				...
				'text'     => array(
					__('You still has a couple of thing to do configuration-wise. Check the steps on this list and make sure you complete them all.', 'wp-ultimo'),
				),
				'attachTo' => array(
	...
	public function output_widget_first_steps() {
		...
		$steps = array(
			'inital-setup'        => array(
				...
				'desc'         => __('Go though the initial Setup Wizard to configure the basic settings of your network.', 'wp-ultimo'),
			...
			'your-first-customer' => array(
				...
				'desc'         => __('Open the link below in an incognito tab and go though your newly created signup form.', 'wp-ultimo'),
		...
		WP_Ultimo()->helper->render('dashboard-widgets/first-steps', array(
			'steps'      => $steps,
	...
	public function output_widget_news() {
		...
		WP_Ultimo()->helper->render('dashboard-widgets/news');
	...
	public function output_widget_activity_stream() {
		...
		WP_Ultimo()->helper->render('dashboard-widgets/activity-stream');
	...
	public function output_widget_summary() {
		...
		WP_Ultimo()->helper->render('dashboard-widgets/summary', array(
			'signups'       => $signups,
