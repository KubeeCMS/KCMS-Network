...
class Signup_Field_Submit_Button extends Base_Signup_Field {
	...
	public function get_icon() {
		...
		return 'dashicons-wu-arrow-with-circle-right';
	...
	public function to_fields_array($attributes) {
		...
		return array(
			$attributes['id'] . '_errors' => array(
				'type'              => 'html',
				'wrapper_classes'   => 'wu_submit_button_errors wu-clear-both',
				'content'           => '<span v-cloak class="wu-block wu-bg-red-100 wu-p-2 wu-mb-4" v-html="get_errors().join(\'<br>\')"></span>',
			...
			$attributes['id']             => array(
				'type'            => 'submit',
				'wrapper_classes' => 'wu_submit_button',
