...
<div class="wu-styling">
  ...
  <div class="rss-widget">
    ...
    <div class='wu-rss-widget-title wu-uppercase wu-font-semibold wu-text-gray-600 wu-text-xs wu-mb-3 wu-py-1'><?php _e('From the Blog', 'wp-ultimo'); ?></div>
  ...
  <div style="margin: 12px -12px -12px;" class="wu-p-4 wu-bg-gray-100 wu-border-solid wu-border-0 wu-border-t wu-text-right wu-border-gray-300">
    ...
    <a target="_blank" href="<?php echo 'https://wpultimo.com/facebook-group'; ?>" class="button button-primary wu-w-full wu-text-center">
      <?php _e('Join our Facebook Group!', 'wp-ultimo'); ?> &rarr;
    </a>
