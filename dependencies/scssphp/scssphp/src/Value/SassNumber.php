...
abstract class SassNumber extends Value
{
     ...
     */
    private const CONVERSIONS = ['in' => ['in' => 1, 'pc' => 6, 'pt' => 72, 'px' => 96, 'cm' => 2.54, 'mm' => 25.4, 'q' => 101.6], 'deg' => [
        'deg' => 360,
        'grad' => 400,
     ...
     * @return self
     */
    public static final function create($value, ?string $unit = null) : SassNumber
    {
        if ($unit === null) {
     ...
     * @return self
     */
    public static final function withUnits($value, array $numeratorUnits = [], array $denominatorUnits = []) : SassNumber
    {
     ...
     * @return list<string>
     */
    public abstract function getNumeratorUnits() : array;
    /**
     * @return list<string>
     */
    public abstract function getDenominatorUnits() : array;
    /**
     * @return array{SassNumber, SassNumber}|null
     *
     * @internal
     */
    public final function getAsSlash() : ?array
    {
        return $this->asSlash;
    }
     ...
     * @return self
     */
    protected abstract function withValue($value) : SassNumber;
    /**
     ...
     * @internal
     */
    public abstract function withSlash(SassNumber $numerator, SassNumber $denominator) : SassNumber;
     ...
     * @return boolean
     */
    public abstract function hasUnits() : bool;
    /**
     ...
     * @return bool
     */
    public abstract function hasUnit(string $unit) : bool;
    /**
     ...
     * @internal
     */
    public abstract function hasPossiblyCompatibleUnits(SassNumber $other) : bool;
    /**
     ...
     * @return bool
     */
    public abstract function compatibleWithUnit(string $unit) : bool;
    /**
