...
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Ast\Sass\Statement\CallableDeclaration;
...
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Ast\Sass\Statement\ParentStatement;
...
abstract class StatementSearchVisitor implements StatementVisitor
{
    ...
    {
        $value = $this->searchIterable($invocation->getPositional(), [$this, 'visitExpression']) ?? $this->searchIterable($invocation->getNamed(), [$this, 'visitExpression']);
        if ($value !== null) {
            return $value;
        }
