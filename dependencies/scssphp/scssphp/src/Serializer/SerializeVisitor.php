...
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Ast\Css\CssMediaQuery;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Ast\Css\CssNode;
...
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Ast\Css\CssValue;
...
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Exception\SassRuntimeException;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Exception\SassScriptException;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\OutputStyle;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Parser\LineScanner;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Parser\Parser;
...
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Util\NumberUtil;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Value\CalculationInterpolation;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Value\CalculationOperation;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Value\CalculationOperator;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Value\ColorFormat;
...
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Value\Value;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Visitor\CssVisitor;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Visitor\SelectorVisitor;
use WP_Ultimo\Dependencies\ScssPhp\ScssPhp\Visitor\ValueVisitor;
/**
 * @internal
 *
...
final class SerializeVisitor implements CssVisitor, ValueVisitor, SelectorVisitor
{
     ...
     */
    public function __construct(bool $inspect = \false, bool $quote = \true, string $style = OutputStyle::EXPANDED)
    {
    ...
    private function writeReindentedValue(CssDeclaration $node) : void
    {
        ...
        if ($minimumIndentation === -1) {
            $this->buffer->write(Util\StringUtil::trimAsciiRight($value, \true));
            $this->buffer->writeChar(' ');
            return;
        }
    ...
    private function writeNumber($number) : void
    {
        ...
        $output = \number_format($number, SassNumber::PRECISION, '.', '');
