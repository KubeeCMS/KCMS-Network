...
final class Domain implements JsonSerializable
{
    ...
    {
        return null !== $this->publicSuffix && \strpos($this->domain, '.') > 0 && $this->publicSuffix !== $this->domain;
    }
    /**
    ...
    {
        return ['domain' => $this->domain, 'registrableDomain' => $this->registrableDomain, 'subDomain' => $this->subDomain, 'publicSuffix' => $this->publicSuffix, 'isCANN' => $this->isValid];
    }
    /**
     * {@inheritdoc}
     */
