...
class Http extends AbstractUri implements Psr7UriInterface
{
     ...
     * @inheritdoc
     */
    protected static $supported_schemes = ['http' => 80, 'https' => 443];
    /**
    ...
    {
        return '' !== $this->host && (null === $this->scheme || isset(static::$supported_schemes[$this->scheme])) && !('' != $this->scheme && null === $this->host);
    }
    /**
     * @inheritdoc
     */
