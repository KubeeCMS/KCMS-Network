...
class Data extends AbstractUri
{
     ...
     * @inheritdoc
     */
    protected static $supported_schemes = ['data' => null];
    /**
    ...
    {
        return 'data' === $this->scheme && null === $this->authority && null === $this->query && null === $this->fragment;
    }
    /**
    ...
    public static function createFromPath(string $path) : self
    {
        ...
        return new static('data', null, null, null, null, $mimetype . ';base64,' . base64_encode(file_get_contents($path)));
    }
}
