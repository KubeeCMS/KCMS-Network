...
class Ws extends AbstractUri
{
     ...
     * @inheritdoc
     */
    protected static $supported_schemes = ['ws' => 80, 'wss' => 443];
    /**
    ...
    {
        return null === $this->fragment && '' !== $this->host && (null === $this->scheme || isset(static::$supported_schemes[$this->scheme])) && !('' != $this->scheme && null === $this->host);
    }
    /**
     * @inheritdoc
     */
