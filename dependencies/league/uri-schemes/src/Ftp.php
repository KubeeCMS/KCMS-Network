...
class Ftp extends AbstractUri
{
     ...
     * @inheritdoc
     */
    protected static $supported_schemes = ['ftp' => 21];
    /**
    ...
    {
        return null === $this->query && null === $this->fragment && '' !== $this->host && (null === $this->scheme || isset(static::$supported_schemes[$this->scheme])) && !('' != $this->scheme && null === $this->host);
    }
}
