...
class File extends AbstractUri
{
     ...
     * @inheritdoc
     */
    protected static $supported_schemes = ['file' => null];
    /**
    ...
    {
        return null === $this->user_info && null === $this->port && null === $this->query && null === $this->fragment && in_array($this->scheme, [null, 'file'], \true) && !('' != $this->scheme && null === $this->host);
    }
    /**
