...
use WP_Ultimo\Dependencies\League\Uri\Components\ComponentInterface;
use WP_Ultimo\Dependencies\League\Uri\Components\EncodingInterface;
use WP_Ultimo\Dependencies\League\Uri\Components\Fragment;
...
use WP_Ultimo\Dependencies\League\Uri\Components\UserInfo;
...
class Formatter implements EncodingInterface
{
    ...
    public function setEncoding(int $enc_type)
    {
        ...
        if (null === $enc_type_list) {
            $enc_type_list = [self::RFC1738_ENCODING => 1, self::RFC3986_ENCODING => 1, self::RFC3987_ENCODING => 1, self::NO_ENCODING => 1];
        }
    ...
    public function setQuerySeparator(string $separator)
    {
        ...
        $this->query_separator = \trim($separator);
    }
    /**
    ...
    public function __invoke($input)
    {
        ...
        if ($input instanceof DeprecatedLeagueUriInterface || $input instanceof Psr7UriInterface || $input instanceof UriInterface) {
