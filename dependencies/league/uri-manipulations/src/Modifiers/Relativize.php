...
use function WP_Ultimo\Dependencies\League\Uri\is_relative_path;
/**
...
class Relativize implements UriMiddlewareInterface
{
    ...
    protected function isRelativizable($payload) : bool
    {
        ...
        return $this->base_uri->getScheme() === $payload->getScheme() && $this->base_uri->getAuthority() === $payload->getAuthority() && !is_relative_path($payload);
    }
    /**
    ...
    protected function formatPath(string $path) : string
    {
        if ('' === $path) {
            ...
            return \in_array($base_path, ['', '/'], \true) ? $base_path : './';
        }
