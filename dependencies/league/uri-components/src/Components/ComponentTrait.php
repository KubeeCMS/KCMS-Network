...
trait ComponentTrait
{
    ...
    {
        $regexp = '/(?:[^' . self::$unreserved_chars . self::$subdelim_chars . '\\:\\/@]+|%(?!' . self::$encoded_chars . '))/x';
    ...
    protected static function assertValidEncoding(int $enc_type)
    {
        ...
        if (null === $enc_type_list) {
            $enc_type_list = [EncodingInterface::RFC1738_ENCODING => 1, EncodingInterface::RFC3986_ENCODING => 1, EncodingInterface::RFC3987_ENCODING => 1, EncodingInterface::NO_ENCODING => 1];
        }
