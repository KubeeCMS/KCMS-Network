...
trait PathInfoTrait
{
     ...
     */
    protected abstract function assertValidEncoding(int $enc_type);
    /**
     * Return the decoded string representation of the component.
     *
     */
    protected abstract function getDecoded() : string;
    /**
     ...
     */
    protected abstract function encodePath(string $str) : string;
    /**
     * Convert a RFC3986 encoded string into a RFC1738 string.
     *
     *
     */
    protected abstract function toRFC1738(string $str) : string;
    /**
     ...
     *
     */
    public abstract function withContent($value) : ComponentInterface;
    /**
