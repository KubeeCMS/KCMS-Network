...
class Query implements ComponentInterface, Countable, IteratorAggregate
{
     ...
     *
     */
    public static function extract(string $str, string $separator = '&', int $enc_type = self::RFC3986_ENCODING) : array
    {
     ...
     *
     */
    public static function parse(string $str, string $separator = '&', int $enc_type = self::RFC3986_ENCODING) : array
    {
     ...
     *
     */
    public static function build($pairs, string $separator = '&', int $enc_type = self::RFC3986_ENCODING) : string
    {
    ...
    {
        return ['component' => $this->getContent(), 'pairs' => $this->pairs, 'separator' => $this->separator];
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function keys(...$args) : array
    {
        ...
        return \array_keys($this->pairs, $args[0], \true);
    }
    /**
     * {@inheritdoc}
     */
