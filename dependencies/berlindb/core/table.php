...
abstract class Table extends Base
{
    ...
    {
        $this->db_version = $this->is_global() ? delete_network_option(get_main_network_id(), $this->db_version_key, \false) : delete_option($this->db_version_key, \false);
    }
    /**
    ...
    {
        return (bool) (\defined('WP_TESTS_DIR') && WP_TESTS_DIR) || \function_exists('WP_Ultimo\\Dependencies\\_manually_load_plugin');
    }
    /**
