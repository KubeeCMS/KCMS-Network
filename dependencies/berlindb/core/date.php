...
use WP_Ultimo\Dependencies\BerlinDB\Database\Base;
/**
...
class Date extends Base
{
    ...
    public function sanitize_query($queries = array(), $parent_query = array())
    {
        ...
        $retval = array();
        // Setup defaults.
        $defaults = array('column' => $this->get_column(), 'compare' => $this->get_compare(), 'relation' => $this->get_relation());
    ...
    public function build_mysql_datetime($datetime = '', $default_to_max = \false)
    {
        ...
        if (!isset($datetime['day'])) {
            $datetime['day'] = !empty($default_to_max) ? (int) \date('t', \mktime(0, 0, 0, $datetime['month'], 1, $datetime['year'])) : 1;
        }
        // Hour
