...
final class Promise implements \React\Promise\PromiseInterface
{
    ...
    public function done(callable $onFulfilled = null, callable $onRejected = null) : void
    {
        ...
        $this->handlers[] = static function (\React\Promise\PromiseInterface $promise) use($onFulfilled, $onRejected) {
    ...
    private function resolver(callable $onFulfilled = null, callable $onRejected = null) : callable
    {
        return function ($resolve, $reject) use($onFulfilled, $onRejected) {
            $this->handlers[] = static function (\React\Promise\PromiseInterface $promise) use($onFulfilled, $onRejected, $resolve, $reject) {
    ...
    private function unwrap($promise) : \React\Promise\PromiseInterface
    {
