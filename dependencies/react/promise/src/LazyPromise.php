 ...
 */
class LazyPromise implements \WP_Ultimo\Dependencies\React\Promise\ExtendedPromiseInterface, \WP_Ultimo\Dependencies\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \WP_Ultimo\Dependencies\React\Promise\RejectedPromise($exception);
