...
final class CachingExecutor implements \React\Dns\Query\ExecutorInterface
{
    /**
    ...
    private $executor;
    private $cache;
    public function __construct(\React\Dns\Query\ExecutorInterface $executor, CacheInterface $cache)
    {
