...
final class FallbackExecutor implements \React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $fallback;
    public function __construct(\React\Dns\Query\ExecutorInterface $executor, \React\Dns\Query\ExecutorInterface $fallback)
    {
