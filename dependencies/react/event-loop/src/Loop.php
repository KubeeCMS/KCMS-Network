...
final class Loop
{
    ...
    {
        if (self::$instance instanceof \React\EventLoop\LoopInterface) {
            return self::$instance;
        }
        self::$instance = $loop = \React\EventLoop\Factory::create();
     ...
     * @return void
     */
    public static function set(\React\EventLoop\LoopInterface $loop)
    {
        self::$instance = $loop;
    }
    /**
     ...
     */
    public static function cancelTimer(\React\EventLoop\TimerInterface $timer)
    {
