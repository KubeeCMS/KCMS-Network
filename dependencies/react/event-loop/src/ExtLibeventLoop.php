 ...
 */
final class ExtLibeventLoop implements \WP_Ultimo\Dependencies\React\EventLoop\LoopInterface
{
    /** @internal */
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \WP_Ultimo\Dependencies\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
