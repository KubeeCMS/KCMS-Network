...
final class Factory
{
    ...
    private static function construct()
    {
        ...
        if (\function_exists('uv_loop_new')) {
            ...
            return new \React\EventLoop\ExtUvLoop();
        }
        if (\class_exists('WP_Ultimo\\Dependencies\\libev\\EventLoop', \false)) {
            return new \React\EventLoop\ExtLibevLoop();
        }
        ...
        if (\function_exists('event_base_new') && \PHP_MAJOR_VERSION === 5) {
            ...
            return new \React\EventLoop\ExtLibeventLoop();
        }
        return new \React\EventLoop\StreamSelectLoop();
