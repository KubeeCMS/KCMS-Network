...
class Session
{
     ...
     *
     */
    const FLASH_NEXT = 'WP_Ultimo\\Dependencies\\Aura\\Session\\Flash\\Next';
    /**
     *
     ...
     *
     */
    const FLASH_NOW = 'WP_Ultimo\\Dependencies\\Aura\\Session\\Flash\\Now';
    /**
     *
    ...
    public function setDeleteCookie($delete_cookie)
    {
        ...
        if (!$this->delete_cookie) {
            ...
            $this->delete_cookie = function ($name, $params) use($phpfunc) {
                $phpfunc->setcookie($name, '', \time() - 42000, $params['path'], $params['domain']);
            };
        }
    }
    /**
    ...
    public function setCookieParams(array $params)
    {
        ...
        $this->phpfunc->session_set_cookie_params($this->cookie_params['lifetime'], $this->cookie_params['path'], $this->cookie_params['domain'], $this->cookie_params['secure'], $this->cookie_params['httponly']);
    }
    /**
     *
    ...
    {
        $result = $this->phpfunc->session_regenerate_id(\true);
