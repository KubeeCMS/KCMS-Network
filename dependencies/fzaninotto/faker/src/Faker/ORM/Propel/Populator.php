...
class Populator
{
    ...
    public function execute($con = null)
    {
        ...
        $isInstancePoolingEnabled = \WP_Ultimo\Dependencies\Propel::isInstancePoolingEnabled();
        \WP_Ultimo\Dependencies\Propel::disableInstancePooling();
        ...
        if ($isInstancePoolingEnabled) {
            \WP_Ultimo\Dependencies\Propel::enableInstancePooling();
        }
    ...
    protected function getConnection()
    {
        ...
        $peer = $class::PEER;
        return \WP_Ultimo\Dependencies\Propel::getConnection($peer::DATABASE_NAME, \WP_Ultimo\Dependencies\Propel::CONNECTION_WRITE);
    }
}
