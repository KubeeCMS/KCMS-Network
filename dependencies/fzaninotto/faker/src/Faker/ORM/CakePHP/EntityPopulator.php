...
use WP_Ultimo\Dependencies\Cake\ORM\TableRegistry;
class EntityPopulator
{
    ...
    public function guessColumnFormatters($populator)
    {
        ...
        $guessers = $populator->getGuessers() + ['ColumnTypeGuesser' => new \Faker\ORM\CakePHP\ColumnTypeGuesser($populator->getGenerator())];
