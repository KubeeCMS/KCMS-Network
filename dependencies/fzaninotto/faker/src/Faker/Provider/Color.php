 ...
 * @author lsv
 */
class Color extends \Faker\Provider\Base
{
    ...
    {
        return \sprintf('%s,%s,%s', static::numberBetween(0, 360), static::numberBetween(0, 100), static::numberBetween(0, 100));
    }
    /**
    ...
    {
        return array(static::numberBetween(0, 360), static::numberBetween(0, 100), static::numberBetween(0, 100));
    }
}
