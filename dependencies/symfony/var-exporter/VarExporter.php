...
use WP_Ultimo\Dependencies\Symfony\Component\VarExporter\Exception\ExceptionInterface;
use WP_Ultimo\Dependencies\Symfony\Component\VarExporter\Internal\Exporter;
use WP_Ultimo\Dependencies\Symfony\Component\VarExporter\Internal\Hydrator;
use WP_Ultimo\Dependencies\Symfony\Component\VarExporter\Internal\Registry;
use WP_Ultimo\Dependencies\Symfony\Component\VarExporter\Internal\Values;
/**
...
final class VarExporter
{
    ...
    {
        $isStaticValue = \true;
        if (!\is_object($value) && !(\is_array($value) && $value) && !\is_resource($value) || $value instanceof \WP_Ultimo\Dependencies\UnitEnum) {
