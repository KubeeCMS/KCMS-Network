...
EOF;
        ...
        if (!isset($standardRules[$position])) {
            ...
            if (\class_exists(\Symfony\Component\Translation\Exception\InvalidArgumentException::class)) {
                throw new \Symfony\Component\Translation\Exception\InvalidArgumentException($message);
            }
