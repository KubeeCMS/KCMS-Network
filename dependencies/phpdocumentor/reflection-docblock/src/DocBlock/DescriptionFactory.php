...
class DescriptionFactory
{
     ...
     */
    public function __construct(\WP_Ultimo\Dependencies\phpDocumentor\Reflection\DocBlock\TagFactory $tagFactory)
    {
     ...
     * @return Description
     */
    public function create($contents, \WP_Ultimo\Dependencies\phpDocumentor\Reflection\Types\Context $context = null)
    {
        list($text, $tags) = $this->parse($this->lex($contents), $context);
        return new \WP_Ultimo\Dependencies\phpDocumentor\Reflection\DocBlock\Description($text, $tags);
    }
    /**
     ...
     * @return string[]|Tag[]
     */
    private function parse($tokens, \WP_Ultimo\Dependencies\phpDocumentor\Reflection\Types\Context $context)
    {
        $count = \count($tokens);
        $tagCount = 0;
        $tags = [];
