 ...
 */
final class Author extends \WP_Ultimo\Dependencies\phpDocumentor\Reflection\DocBlock\Tags\BaseTag implements \WP_Ultimo\Dependencies\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    ...
    {
        \WP_Ultimo\Dependencies\Webmozart\Assert\Assert::string($authorName);
        \WP_Ultimo\Dependencies\Webmozart\Assert\Assert::string($authorEmail);
