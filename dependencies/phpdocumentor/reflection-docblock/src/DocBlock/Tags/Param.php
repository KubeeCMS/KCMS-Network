 ...
 */
final class Param extends \WP_Ultimo\Dependencies\phpDocumentor\Reflection\DocBlock\Tags\TagWithType implements \WP_Ultimo\Dependencies\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    /** @var string */
     ...
     */
    public function __construct($variableName, \WP_Ultimo\Dependencies\phpDocumentor\Reflection\Type $type = null, $isVariadic = \false, \WP_Ultimo\Dependencies\phpDocumentor\Reflection\DocBlock\Description $description = null)
    {
        \WP_Ultimo\Dependencies\Webmozart\Assert\Assert::string($variableName);
        \WP_Ultimo\Dependencies\Webmozart\Assert\Assert::boolean($isVariadic);
        $this->name = 'param';
