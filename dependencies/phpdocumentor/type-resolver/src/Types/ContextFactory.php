...
final class ContextFactory
{
    ...
    public function createFromReflector(\Reflector $reflector)
    {
        ...
        return new \WP_Ultimo\Dependencies\phpDocumentor\Reflection\Types\Context($namespace, []);
    }
    /**
    ...
    public function createForNamespace($namespace, $fileContents)
    {
        ...
        return new \WP_Ultimo\Dependencies\phpDocumentor\Reflection\Types\Context($namespace, $useStatements);
    }
    /**
