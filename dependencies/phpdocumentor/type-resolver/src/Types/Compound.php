 ...
 */
final class Compound implements \WP_Ultimo\Dependencies\phpDocumentor\Reflection\Type, \IteratorAggregate
{
    /** @var Type[] */
    private $types;
    /**
    ...
    public function __construct(array $types)
    {
        foreach ($types as $type) {
            if (!$type instanceof \WP_Ultimo\Dependencies\phpDocumentor\Reflection\Type) {
