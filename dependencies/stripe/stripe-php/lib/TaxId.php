 ...
 */
class TaxId extends \WP_Ultimo\Dependencies\Stripe\ApiResource
{
    ...
    public function instanceUrl()
    {
        ...
        if (!$id) {
            throw new \WP_Ultimo\Dependencies\Stripe\Exception\UnexpectedValueException("Could not determine which URL to request: class instance has invalid ID: {$id}");
        }
