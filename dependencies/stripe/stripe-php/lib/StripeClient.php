 ...
 */
class StripeClient extends \WP_Ultimo\Dependencies\Stripe\BaseStripeClient
{
    /**
    ...
    public function __get($name)
    {
        if (null === $this->coreServiceFactory) {
            $this->coreServiceFactory = new \WP_Ultimo\Dependencies\Stripe\Service\CoreServiceFactory($this);
        }
