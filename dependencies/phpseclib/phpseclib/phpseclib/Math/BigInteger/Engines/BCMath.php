...
class BCMath extends \phpseclib3\Math\BigInteger\Engines\Engine
{
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if (!self::$isValidEngine) {
            throw new \phpseclib3\Exception\BadConfigurationException('BCMath is not setup correctly on this system');
        }
        $this->value = '0';
    ...
    protected function initialize($base)
    {
        switch (\abs($base)) {
            ...
            case 16:
                ...
                $temp = new self(\WP_Ultimo\Dependencies\ParagonIE\ConstantTime\Hex::decode($x), 256);
