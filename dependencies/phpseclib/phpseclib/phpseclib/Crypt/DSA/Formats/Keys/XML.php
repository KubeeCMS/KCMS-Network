...
abstract class XML
{
    ...
    {
        return "<DSAKeyValue>\r\n" . '  <P>' . \WP_Ultimo\Dependencies\ParagonIE\ConstantTime\Base64::encode($p->toBytes()) . "</P>\r\n" . '  <Q>' . \WP_Ultimo\Dependencies\ParagonIE\ConstantTime\Base64::encode($q->toBytes()) . "</Q>\r\n" . '  <G>' . \WP_Ultimo\Dependencies\ParagonIE\ConstantTime\Base64::encode($g->toBytes()) . "</G>\r\n" . '  <Y>' . \WP_Ultimo\Dependencies\ParagonIE\ConstantTime\Base64::encode($y->toBytes()) . "</Y>\r\n" . '</DSAKeyValue>';
    }
}
