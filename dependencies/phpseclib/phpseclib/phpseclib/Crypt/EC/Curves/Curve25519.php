...
class Curve25519 extends \phpseclib3\Crypt\EC\BaseCurves\Montgomery
{
    public function __construct()
    {
        ...
        $this->a24 = $this->factory->newInteger(new \phpseclib3\Math\BigInteger('121666'));
        $this->p = [$this->factory->newInteger(new \phpseclib3\Math\BigInteger(9))];
    ...
    public function multiplyPoint(array $p, \phpseclib3\Math\Common\FiniteField\Integer $d)
    {
        ...
        $d = \strrev($d);
        $d |= "@";
        $d = $this->factory->newInteger(new \phpseclib3\Math\BigInteger($d, -256));
