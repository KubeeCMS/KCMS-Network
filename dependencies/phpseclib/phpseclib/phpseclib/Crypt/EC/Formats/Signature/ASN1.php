...
abstract class ASN1
{
    ...
    public static function load($sig)
    {
        ...
        $components = \phpseclib3\File\ASN1::asn1map($decoded[0], \phpseclib3\File\ASN1\Maps\EcdsaSigValue::MAP);
        return $components;
    }
    /**
    ...
    {
        return \phpseclib3\File\ASN1::encodeDER(\compact('r', 's'), \phpseclib3\File\ASN1\Maps\EcdsaSigValue::MAP);
    }
}
