...
}, 'lastDay' => '[Wczoraj o] LT', 'lastWeek' => function (\WP_Ultimo\Dependencies\Carbon\CarbonInterface $date) {
    switch ($date->dayOfWeek) {
        case 0:
