...
class Factory
{
    protected $className = \WP_Ultimo\Dependencies\Carbon\Carbon::class;
    protected $settings = [];
    ...
    public function __call($name, $arguments)
    {
        ...
        return $result instanceof \WP_Ultimo\Dependencies\Carbon\CarbonInterface && !empty($settings) ? $result->settings($settings) : $result;
    }
}
