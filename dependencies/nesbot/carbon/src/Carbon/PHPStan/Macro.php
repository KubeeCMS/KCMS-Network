...
use Closure;
use WP_Ultimo\Dependencies\PHPStan\Reflection\Php\BuiltinMethodReflection;
use WP_Ultimo\Dependencies\PHPStan\TrinaryLogic;
use ReflectionClass;
...
use stdClass;
use Throwable;
final class Macro implements \WP_Ultimo\Dependencies\PHPStan\Reflection\Php\BuiltinMethodReflection
{
    /**
     * The class name.
     *
     ...
     * {@inheritdoc}
     */
    public function isDeprecated() : \WP_Ultimo\Dependencies\PHPStan\TrinaryLogic
    {
        return \WP_Ultimo\Dependencies\PHPStan\TrinaryLogic::createFromBoolean($this->reflectionFunction->isDeprecated() || \preg_match('/@deprecated/i', $this->getDocComment() ?: ''));
    }
    /**
     * {@inheritdoc}
     */
     ...
     * {@inheritdoc}
     */
    public function getPrototype() : \WP_Ultimo\Dependencies\PHPStan\Reflection\Php\BuiltinMethodReflection
    {
        return $this;
    }
    /**
